...
<input type="file" required  name="img2" accept="image/png, image/jpeg,image/jpg" onchange="$Fgetter(this,'user-getlink')" id="user-img" style="height:0;width:0;outline: none; display: block;background: transparent;" >
        ...
        <div class="d-flex p-3 m-3 align-items-center" style="width: 100%;height: 50px;">
            <img src="uploads/<?php  echo $Sci_prof; ?>" id="user-getlink0" onclick="
            $trigger('user-img0')" style="fill: gray; cursor: pointer;  width: 50px;border-radius: 50px; " class="m-3 p-1">
<small class="fw-bold" style="color: gray;">Author image</small>
<input type="file" required  name="img3" accept="image/png, image/jpeg,image/jpg" onchange="$Fgetter(this,'user-getlink0')" id="user-img0" style="height:0;width:0;outline: none; display: block;background: transparent;" >
...
setTimeout(function () {
 ...
 setTimeout(function () {
  // body...
$space_nav_loader('Profile.php','sign','s-btn7')
